...
// SQL query
$sql = "SELECT id, name, email, vehicle_number, service_type, preferred_date, additional_notes FROM service_requests_1";
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        echo "<tr>
                                ...
                                <td>
                                    <a href='approve_database.php?id={$row['id']}&action=approve'>Approve</a> | 
                                    <a href='approve_database.php?id={$row['id']}&action=reject'>Reject</a>
                                </td>
                              </tr>";
                    }
                } else {
